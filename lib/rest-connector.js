...
RestConnector.prototype.define = function defineModel(definition) {
  ...
  this._resources[m] = new RestResource(definition.settings.resourceName ||
    definition.model.modelName || definition.model.pluralModelName, this._baseURL, this._request);
 ...
 * @param {function} [callback] The callback function
 */
RestConnector.prototype.create = function create(model, data, callback, additionalHeaders = {}) {
...
/**
 * Create instances of the model with the given data array
 * @param {string} model The model name
 * @param {object} data Array of model data
 * @param {function} [callback] The callback function
 */
RestConnector.prototype.createAll = function createAll(model, data, callback, additionalHeaders = {}) {
  var self = this;
  if (Array.isArray(data)) {
    AsyncJS.eachSeries(data, function(item, cb) { return self.create(model, item, cb, additionalHeaders); }, callback);
  } else {
    var err = g.f('Incorrect collection data', data);
    if (callback) callback(err);
  }
};
 ...
 * @param {function} [callback] The callback function
 * */
RestConnector.prototype.updateOrCreate = function(model, data, callback, additionalHeaders = {}) {
  var self = this;
  this.exists(model, data.id, function(err, exists) {
    if (exists) {
      self.save(model, data, callback, additionalHeaders);
    } else {
...
RestConnector.prototype.responseHandler = function(model, callback, many) {
  ...
  return function(err, body, response) {
    ...
    if (response.statusCode === 200) {
      ...
      if (callback) {
        result = self.postProcess(model, body, many);
        callback(null, result);
      }
    } else {
      err = g.f('Error response: %d %j', response.statusCode, body);
 ...
 * @param {function} [callback] The callback function
 */
RestConnector.prototype.save = function save(model, data, callback, additionalHeaders = {}) {
  Object.keys(data).forEach(key=>{
    if (data[key]) {
      delete data[key];
    }
  });
  this.getResource(model).save(data, this.responseHandler(model, callback), additionalHeaders);
};

/**
 * replace an instance of a given model completely
 * @param {string} model The model name
 * @param {object} id The id paramter
 * @param {object} data The model instance data
 * @param {function} [callback] The callback function
 */
RestConnector.prototype.replaceById = function save(model, id, data, callback, additionalHeaders = {}) {
  data.id = id;
  this.getResource(model).save(data, this.responseHandler(model, callback), additionalHeaders);
};
 ...
 * @param {function} [callback] The callback function
 */
RestConnector.prototype.exists = function exists(model, id, callback, additionalHeaders = {}) {
  this.getResource(model).findById(id, function(err, body, response) {
    if (err) {
      if (callback) callback(err, body);
      return;
    }
 ...
 * @param {function} [callback] The callback function
 */
RestConnector.prototype.findOne = function findOne(model, filter = {}, callback, additionalHeaders = {}) {
  var self = this;
  filter.limit = 1;
  this.find(model, filter, function(err, data) {
    if (err) {
 ...
 * @param {function} [callback] The callback function
 */
RestConnector.prototype.findById = function find(model, id, callback, additionalHeaders = {}) {
  this.getResource(model).findById(id, this.responseHandler(model, callback), additionalHeaders);
};
 ...
 * @param {function} [callback] The callback function
 */
RestConnector.prototype.destroy = function destroy(model, id, callback, additionalHeaders = {}) {
  this.getResource(model).deleteById(id, this.responseHandler(model, callback), additionalHeaders);
};
 ...
 * @param {function} [callback] The callback function
 */
RestConnector.prototype.find = RestConnector.prototype.all = function all(model, filter, callback, additionalHeaders = {}) {
  ...
  //   }
  // }
  this.getResource(model).all(filter, this.responseHandler(model, callback, true), additionalHeaders);
};
...
RestConnector.prototype.destroyAll = RestConnector.prototype.deleteAll = function destroyAll(model, where, callback, additionalHeaders = {}) {
  if (!Object.keys(where).includes('where')) {
    where = {where: where};
  }
  var self = this;
  this.find(model, where, function(err, records) {
    if (err) {
      if (callback) return callback(err);
    }
    AsyncJS.eachSeries(records, function(item, cb) { return self.delete(model, item, cb, additionalHeaders); }, callback);
  }, additionalHeaders);
};
 ...
 */
RestConnector.prototype.count = function count(model, where, callback, additionalHeaders = {}) {
  this.getResource(model).count(where, callback, additionalHeaders);
};
 ...
 * @param {function} [callback] The callback function
 */
RestConnector.prototype.updateAttributes = function(model, id, data, callback, additionalHeaders = {}) {
  data.id = id;
  this.save(model, data, callback, additionalHeaders);
};
 ...
 * @param {function} [callback] The callback function
 */
RestConnector.prototype.update = RestConnector.prototype.updateAll = function updateAll(model, where, data, callback, additionalHeaders = {}) {
  this.getResource(model).updateAll(where, data, callback, additionalHeaders);
};

/**
 * delete record for a given instance
 * @param {string} model The model name
 * @param {object} entity The entity instance
 * @param {function} [callback] The callback function
 */
RestConnector.prototype.delete = function(model, entity, callback, additionalHeaders = {}) {
  if (!entity.id) {
    var err = g.f('Incorrect entity data', entity);
    if (callback) callback(err);
  }
  this.getResource(model).deleteById(entity.id, (err, body, response)=>{
    if (err) {
      if (callback) callback(err, body);
      return;
    }
